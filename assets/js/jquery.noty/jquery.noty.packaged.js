    ...
    $.noty.themes.defaultTheme = {
            ...
            borderFix: function() {
                if(this.options.dismissQueue) {
                    ...
                    switch(this.options.layout.name) {
                        ...
                        case 'centerRight':
                        case 'inline':
                            $(selector).css({margin: '0px 0px 0px 0px',borderRadius: '0px 0px 0px 0px'});
                            $(selector).first().css({'marginTop':'60px','border-top-left-radius': '0px', 'border-top-right-radius': '0px'});
        ...
        style   : function() {
            ...
            switch(this.options.type) {
                case 'alert':
                case 'notification':
                    this.$bar.css({color: '#444'});
                    break;
                case 'warning':
                    this.$bar.css({color: '#826200'});
